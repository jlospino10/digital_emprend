<?php
  session_start();
    ...
    if(isset($_SESSION['client'])== "client") {
?> 
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="/proyect/Diseño/assets/images/favicon.svg" type="image/x-icon">

    <!-- font css -->
    <link rel="stylesheet" href="/proyect/Diseño/assets/fonts/feather.css">
    <link rel="stylesheet" href="/proyect/Diseño/assets/fonts/fontawesome.css">
    <link rel="stylesheet" href="/proyect/Diseño/assets/fonts/material.css">

    <!-- vendor css -->
    <link rel="stylesheet" href="/proyect/Diseño/assets/css/style.css" id="main-style-link"> 
		...
		<div class="navbar-wrapper">
			...
			<div class="navbar-content">
				<ul class="pc-navbar">
					...
					<li class="pc-item">
						<a href="/proyect/contenido/informacion.php" class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">book</i></span><span class="pc-mtext">Contenido</span></a>
					</li>
					<li class="pc-item pc-caption">
					...
					<li class="pc-item pc-hasmenu">
						...
						<ul class="pc-submenu">
							<li class="pc-item"><a class="pc-link" href="/proyect/payment/payment.php">Agregar metodos de pago</a></li>
							<li class="pc-item"><a class="pc-link" href="/proyect/payment/get_payment.php">Ver metodos de pago</a></li>
					...
					<li class="pc-item pc-hasmenu">
						...
						<ul class="pc-submenu">
							<li class="pc-item"><a class="pc-link" href="/proyect/edit_profile/profile.php">Editar</a></li>
...
.link i:hover{
 ...
 <script src="/proyect/Diseño/assets/js/vendor-all.min.js"></script>
    <script src="/proyect/Diseño/assets/js/plugins/bootstrap.min.js"></script>
    <script src="/proyect/Diseño/assets/js/plugins/feather.min.js"></script>
    <script src="/proyect/Diseño/assets/js/pcoded.min.js"></script>
...
<script src="/proyect/Diseño/assets/js/plugins/apexcharts.min.js"></script>
<script src="/proyect/Diseño/assets/js/pages/chart-apex.js"></script>
</html>
<?php
    }
			...
			<div class="navbar-content">
				<ul class="pc-navbar">
					...
					<li class="pc-item">
					 ...
					 <li class="pc-item pc-caption">
						<label>ADMINISTRAR WEB</label>
						<span>Administracion</span>
					</li>
					<li class="pc-item pc-hasmenu">
						<a  class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">settings</i></span><span class="pc-mtext">Diseño web</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
						<ul class="pc-submenu">
							<li class="pc-item"><a class="pc-link" href="/proyect/admin/administrar.php">Login imagen</a></li>
							<li class="pc-item"><a class="pc-link" href="/proyect/admin/administrar.php">Logo</a></li>
